          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
              ...
              <div className="space-y-3">
                <div className="flex items-center p-4 border border-blue-200 bg-blue-50 rounded-lg cursor-pointer">
                  <input
                    id="payment-cod"
                    name="payment-method"
                    type="radio"
                  ...
                  />
                  <label htmlFor="payment-cod" className="ml-3 block text-sm font-medium text-gray-900">
              ...
              <ul className="divide-y divide-gray-200 mb-6 max-h-80 overflow-y-auto">
                {items.map((item) => (
                  <li key={item.id} className="py-4 flex gap-4">
                    <div className="h-16 w-16 shrink-0 overflow-hidden rounded-md border border-gray-200 relative">
                      {item.image_url ? (
                        <Image
                          src={item.image_url}
                          alt={item.name}
